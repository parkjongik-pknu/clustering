...
* **CWM**CWM is a clustering method about the relationship between a response variable Y and explanatory variables X. While GMM focuses on the distribution of X, CWM focuses on the joint probability distribution $f(x,y)$
